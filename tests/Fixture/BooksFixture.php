...
class BooksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'code' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'isbn' => ['type' => 'string', 'length' => 200, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
        'location' => ['type' => 'string', 'length' => 500, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'quantity' => 1,
            'created' => '2016-02-10 14:47:27',
            'modified' => '2016-02-10 14:47:27',
            'created_by' => 1,
            'modified_by' => 1
        ],
    ];
